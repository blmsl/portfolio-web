/**
 * jquery.gridrotator.js v1.1.0 http://www.codrops.com
 *
 * Licensed under the MIT license.
 * http://www.opensource.org/licenses/mit-license.php
 *
 * Copyright 2012, Codrops http://www.codrops.com
 */
;
(function($, window, undefined) {
  ...
  /*
   * debouncedresize: special jQuery event that happens once after a window
   * resize
   *
  ...
  $.GridRotator.prototype = {
    ...
    _layout: function(callback) {
      ...
      var $outItems = this.$items.filter(':gt(' + (this.showTotal - 1) + ')'), $outAItems = $outItems
          .children('a');
    ...
    _replace: function($out) {
      ...
      this._setTransition($inA, 'all', animProp.animSpeed, animProp.delay,
          this.options.animEasingIn);
      this._setTransition($outA, 'all', animProp.animSpeed, 0,
    ...
    if (typeof options === 'string') {
      ...
      this.each(function() {
        ...
        if (instance) {
          ...
          instance = $.data(this, 'gridrotator', new $.GridRotator(options,
              this));
