...
+function($) {
  ...
  Alert.prototype.close = function(e) {
    ...
    $.support.transition && $parent.hasClass('fade') ? $parent.one(
        $.support.transition.end, removeElement).emulateTransitionEnd(150)
        : removeElement();
  };
...
+function($) {
  ...
  Button.prototype.setState = function(state) {
    ...
    setTimeout(function() {
      state == 'loadingText' ? $el.addClass(d).attr(d, d) : $el.removeClass(d)
          .removeAttr(d);
    }, 0);
  };
...
+function($) {
  ...
  var Carousel = function(element, options) {
    ...
    this.options.pause == 'hover'
        && this.$element.on('mouseenter', $.proxy(this.pause, this)).on(
...
+function($) {
  ...
  Collapse.prototype.hide = function() {
    ...
    var complete = function() {
      this.transitioning = 0;
      this.$element.trigger('hidden.bs.collapse').removeClass('collapsing')
          .addClass('collapse');
    };
    ...
    this.$element[dimension](0).one($.support.transition.end,
        $.proxy(complete, this)).emulateTransitionEnd(350);
  };
...
+function($) {
  ...
  Modal.prototype.show = function(_relatedTarget) {
    ...
    this.$element.on('click.dismiss.modal', '[data-dismiss="modal"]', $.proxy(
        this.hide, this));
    ...
    this.backdrop(function() {
      ...
      transition ? that.$element.find('.modal-dialog') // wait for modal to
                                                        // slide in
  ...
  Modal.prototype.hide = function(e) {
    ...
    $.support.transition && this.$element.hasClass('fade') ? this.$element.one(
        $.support.transition.end, $.proxy(this.hideModal, this))
  ...
  Modal.prototype.backdrop = function(callback) {
    ...
    if (this.isShown && this.options.backdrop) {
      ...
      $.support.transition && this.$element.hasClass('fade') ? this.$backdrop
          .one($.support.transition.end, callback).emulateTransitionEnd(150)
          : callback();
            ...
            function() {
              ...
              return ($href && $href.length && [ [
                  $href[offsetMethod]().top
                      + (!$.isWindow(self.$scrollElement.get(0)) && self.$scrollElement
                          .scrollTop()), href ] ])
                  || null;
            }).sort(function(a, b) {
          return a[0] - b[0];
...
+function($) {
  ...
  var Affix = function(element, options) {
    ...
    this.$window = $(window).on('scroll.bs.affix.data-api',
        $.proxy(this.checkPosition, this)).on('click.bs.affix.data-api',
