...
(function($, window, undefined) {
  ...
  $.GridRotator.prototype = {
    ...
    _layout: function(callback) {
      var self = this;
      // sets the grid dimensions based on the container's width
      this._setGridDim();
      // reset
      this.$list.empty();
    ...
    _setGridDim: function() {
      // container's width
      var c_w = $(this.options.container).width() || this.$el.width(),
        c_h = $(this.options.container).height() || this.$el.height();
      ...
      this.rows = Math.ceil(c_h / (c_w / this.columns));
